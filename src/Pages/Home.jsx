  ...
  return (
    <>
     ...
     <div className="container-fluid d-flex align-items-center justify-content-center bg">
        ...
        :
       <Link to={"/login"} style={{textDecoration:"none", fontFamily:"fantasy"}} ><h2>!!  Touch Here !!  </h2></Link>
...
{ loggedInUser &&     <h2 id="section1" className='text-center mt-4'>  Today's Special </h2>
        ...
        {
          items.map((item => {
            return <div className="col-md-4 col-12" key={item._id} style={{paddingLeft:"20px"}}>
              <div>
                <Item item={item} />
              </div>
            </div>
